package com.chilecompra.springboot.app.view.xlsx;
...
public class FacturaXlsxView extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		response.setHeader("Content-Disposition", "attachment; filename=\"factura_view.xlsx\""); //para cambiar el nombre del archivo
		Factura factura = (Factura) model.get("factura"); //se tiene que llamar igual que en el controlador
		Sheet sheet = workbook.createSheet("Factura Spring"); //creamos nuestra planilla
